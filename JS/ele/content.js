					...
					<div id="row">
						 <div className="col-lg-9 main-chart">
							 	<div className="row mtbox">
												 ...
												 <div className="box1">
														 <span className="fa fa-comment-o"></span>
														 		<h3>933</h3>
														 				...
														 				<p>933 People liked your page the last 24. Whoohoo!</p>
																			</div>
											...
											<div className="col-md-2 col-sm-2 box0">
														<div className="box1">
																	<span className="fa fa-lemon-o"></span>
																		<h3>OK!</h3>
																			</div>
																...
																<div className="white-panel pn">
																		<div className="white-header">
																				<h5>TOP USER</h5>
																						...
																						<p><img src="img/ui-zac.jpg" className="img-circle" width="80"/></p>
																							<p><b>Zac Snider</b></p>
																								<div className="row">
                      ...
                      <div className="col-lg-3 ds">
                          ...
                          <h3>TEAM MEMBERS</h3>
			                       <div className="desc">
			                      	<div className="thumb">
			                      		<img className="img-circle" src="img/ui-divya.jpg" width="35px" height="35px"/>
			                      	</div>
			                      	<div className="details">
			                      	...
			                      	<div className="desc">
                      	<div className="thumb">
                      		<img className="img-circle" src="img/ui-sherman.jpg" width="35px" height="35px" />
                      	</div>
                      	<div className="details">
                      ...
                      <div className="desc">
                      	<div className="thumb">
                      		<img className="img-circle" src="img/ui-danro.jpg" width="35px" height="35px" />
                      	</div>
                      	<div className="details">
                      ...
                      <div className="desc">
                      	<div className="thumb">
                      		<img className="img-circle" src="img/ui-zac.jpg" width="35px" height="35px" />
                      	</div>
                      	<div className="details">
                      ...
                      <div className="desc">
                      	<div className="thumb">
                      		<img className="img-circle" src="img/ui-sam.jpg" width="35px" height="35px" />
                      	</div>
                      	<div className="details">
